...
open class SCLAlertView: UIViewController {
    ...
    override open func viewWillLayoutSubviews() {
        ...
        for btn in buttons {
            ...
            if title == "إلغاء"
            {
            btn.frame = CGRect(x:appearance.kWindowWidth - 70, y:y + 10, width: 70, height:35)
            }
            else
            {
    ...
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showDurationStatus:Bool = false, target:AnyObject, selector:Selector)->SCLButton {
        ...
        var color :UIColor!
        var textColorthis :UIColor!
        if title == "إلغاء"
       {
       // color = UIColor(red: 250/255, green: 169/255, blue: 130/255, alpha: 1.0)
        //color = UIColor.white
        textColorthis = UIColor(red: 250/255, green: 169/255, blue: 130/255, alpha: 1.0)
        }
        else
       {
            textColorthis = UIColor.white
       //color = UIColor(red: 248/255, green: 93/255, blue: 7/255, alpha: 1.0)
        }
        let btn = addButton(title, backgroundColor: color, textColor: textColorthis, showDurationStatus: showDurationStatus)
    ...
    fileprivate func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showDurationStatus:Bool=false)->SCLButton {
        ...
        // Add button
        //let color = UIColor(red: 248/255, green: 93/255, blue: 7/255, alpha: 1.0)
        let btn = SCLButton()
    ...
    open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        ...
        if appearance.showCloseButton {
            let button = addButton(completeText ?? "إلغاء", target:self, selector:#selector(SCLAlertView.hideView))
        }
